...
//        p1.setBackground(Color.BLACK);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1){
            ...
            try {
                ConnectionClass objj=new ConnectionClass();
                String q="insert into intracity_driver(driver,Sorce,destination,car,price) values ('"+name+"','"+source+"','"+destination+"','"+car+"','"+price+"')";
                System.out.print(q);
                int aa=objj.stm.executeUpdate(q);
                if(aa==1)
                {
