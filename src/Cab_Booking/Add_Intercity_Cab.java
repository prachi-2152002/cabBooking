...
public class Add_Intercity_Cab extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1){
            ...
            try {
                ...
                String q="insert into intercity_driver(driver,Sorce,destination,car,price,typ_e) values ('"+name+"','"+source+"','"+destination+"','"+car+"','"+price+"','"+type+"')";
