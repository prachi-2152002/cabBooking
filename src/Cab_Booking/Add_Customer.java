...
public class Add_Customer extends JFrame implements ActionListener{
    ...
    public Add_Customer() {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Cab_booking/Icons/customers.jpg"));
        Image img = ic.getImage().getScaledInstance(1050, 700, Image.SCALE_DEFAULT);
