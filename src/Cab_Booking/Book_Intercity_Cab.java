...
public class Book_Intercity_Cab extends JFrame implements ActionListener{
    ...
    Book_Intercity_Cab() {
        ...
        try {
            ...
            String q="select Sorce from intercity_driver";
        ...
        p2=new JPanel();  
        p2.setLayout(new GridLayout(12,2,10,10));  // for all data 11 row 2 column
        ...
        ch1.addMouseListener(new MouseAdapter() {
           ...
           public void mouseClicked(MouseEvent arg0){
               ...
               try {
                   ...
                   String q1="select destination from intercity_driver where Sorce='"+source+"'";
                   ResultSet rest1=obj.stm.executeQuery(q1);
                   while(rest1.next()){
        ...
        ch2.addMouseListener(new MouseAdapter() {
           ...
           public void mouseClicked(MouseEvent arg0){
               try {
                   ...
                   String q1="select *from intercity_driver where Sorce='"+source+"' and destination ='"+destination+"'";
                   ResultSet rest1=obj.stm.executeQuery(q1);
                   while(rest1.next()){
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1){
            ...
            try {
              ...
              String q1="insert into intercitycab values('"+bid+"','"+username+"','"+name+"','"+dname+"','"+sorce+"','"+destination+"','"+type+"','"+car+"','"+price+"')";
